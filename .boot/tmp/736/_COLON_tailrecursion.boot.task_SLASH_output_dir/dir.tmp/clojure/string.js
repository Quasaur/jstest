...
{{
var G__10135 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10135;
continue;
}
} else
...
{var pred__10139 = cljs.core._EQ_;var expr__10140 = limit;if(cljs.core.truth_(pred__10139.call(null,1,expr__10140)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10139.call(null,2,expr__10140)))
...
var G__10142 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10143 = (limit__$1 - 1);
var G__10144 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10142;
limit__$1 = G__10143;
parts = G__10144;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10146 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10146))
{var replacement_10147 = temp__4124__auto___10146;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10147)));
} else
{buffer.append(ch);
}
{
var G__10148 = (index + 1);
index = G__10148;
continue;
}
}
